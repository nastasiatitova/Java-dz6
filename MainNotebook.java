...
public class MainNotebook {
    public static void main(String[] args) {
        Notebook notebook_1 = new Notebook(128, 500, "Linux", "silver");
        Notebook notebook_2 = new Notebook(256, 3000, "Linux", "silver");
        Notebook notebook_3 = new Notebook(64, 250, "Windows", "black");
        Notebook notebook_4 = new Notebook(256, 1000, "Windows", "white");
        Notebook notebook_5 = new Notebook(512, 10000, "Linux", "black");
        Notebook notebook_6 = new Notebook(128, 500, "Windows", "white");
